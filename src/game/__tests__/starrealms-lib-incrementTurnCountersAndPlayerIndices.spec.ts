import { incrementTurnCountersAndPlayerIndices, getNextPlayerIndex } from '@/game/starrealms-lib';
import { createMockGame, createMockPlayer } from '@/__fixtures__/starrealms-lib-fixtures';
import { IGame } from '@/game/interfaces/game';

jest.mock('@/game/starrealms-lib', () => {
  const originalModule = jest.requireActual('@/game/starrealms-lib');
  return {
    ...originalModule,
